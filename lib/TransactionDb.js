...
var encodedData = require('soop').load('mxtcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('mxtcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('mxtcore/lib/Address', {
